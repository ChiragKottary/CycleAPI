...
namespace CycleAPI.Migrations
{
    ...
    [Migration("20250428114558_AddPhoneAndAddressToUsers")]
    partial class AddPhoneAndAddressToUsers
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CycleAPI.Models.Domain.Payment", b =>
                {
            ...
            modelBuilder.Entity("CycleAPI.Models.Domain.SalesAnalytics", b =>
                {
                    ...
                    b.Property<Guid?>("TopSellingBrandId")
                        .HasColumnType("uuid");

                    b.Property<Guid?>("TopSellingCycleId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TopSellingBrandId");

                    b.HasIndex("TopSellingCycleId");
            ...
            modelBuilder.Entity("CycleAPI.Models.Domain.SalesAnalytics", b =>
                {
                    b.HasOne("CycleAPI.Models.Domain.Brand", "TopSellingBrand")
                        .WithMany()
                        .HasForeignKey("TopSellingBrandId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("CycleAPI.Models.Domain.Cycle", "TopSellingCycle")
                        .WithMany()
                        .HasForeignKey("TopSellingCycleId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.Navigation("TopSellingBrand");

                    b.Navigation("TopSellingCycle");
                });
